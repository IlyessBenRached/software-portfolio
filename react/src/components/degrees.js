...
// Import your icons
import PythonIcon from '../../src/icons/4375050_logo_python_icon.svg';
import SeleniumIcon from '../../src/icons/icons8-selenium-144.svg';
import FastAPIIcon from '../../src/icons/fastapi-1.svg';
import MongoDBIcon from '../../src/icons/1012822_code_development_logo_mongodb_programming_icon.svg';
import ReactJSIcon from '../../src/icons/7423887_react_react native_icon.svg';
import HTMLIcon from '../../src/icons/294678_html5_icon.svg';
import CSSIcon from '../../src/icons/317756_badge_css_css3_achievement_award_icon.svg';
import JavaScriptIcon from '../../src/icons/282802_javascript_js_icon.svg';
import DjangoIcon from '../../src/icons/django.svg';
import MySQLIcon from '../../src/icons/4691303_mysql_icon.svg';
import PostgreSQLIcon from '../../src/icons/4691328_postgresql_icon.svg';
    ...
    services: [
      {
        ...
        icons: [HTMLIcon, CSSIcon, JavaScriptIcon, JavaScriptIcon, DjangoIcon, PythonIcon, FastAPIIcon, MongoDBIcon, MySQLIcon, PostgreSQLIcon],
      },
      {
        name: 'Web Scraping',
        skills: [
        ...
        icons: [PythonIcon, SeleniumIcon, FastAPIIcon],
      },
      {
        ...
        icons: [HTMLIcon, CSSIcon, JavaScriptIcon, JavaScriptIcon, ReactJSIcon, BootstrapIcon],
      },
      {
        ...
        icons: [DjangoIcon, PythonIcon, FastAPIIcon, MongoDBIcon, MySQLIcon, PostgreSQLIcon],
      },
      {
        name: 'Machine Learning',
        skills: [
                { name: 'Natural Language Processing (NLP)', progress: 80 },
                { name: 'Topic Modeling', progress: 80 },
               ],
        icons: [InfoIcon, InfoIcon], // Use InfoIcon as a placeholder for now
      },
    ],
  },
];
