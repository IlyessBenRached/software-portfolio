...
const ContactStack = () => {
  return (
    <Stack className="contact-stack" direction={{ xs: 'column', sm: 'row' }} spacing={2} >
      {/* Contact Information */}
      <Stack className="contact-info" alignItems={{ xs: 'center', sm: 'flex-start' }} spacing={2} >
        <Typography>Email: ilyesbenrached013@gmail.com</Typography>
        <Typography>Phone: +216 29 832 810</Typography>
      </Stack>

      {/* Links of the Website */}
      <Stack className="website-links" alignItems={{ xs: 'center', sm: 'center' }} spacing={4}>
      ...
      {/* Social Icons */}
      <Stack className="social-icons" alignItems={{ xs: 'center', sm: 'flex-end' }} spacing={4}>
